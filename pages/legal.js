      ...
      <div className='landing'>
        <div className='align'>
          ...
          <div>
            ...
            <h2 className='headers2'>
              LAST REVISED ON: NOVEMBER 16, 2022
            </h2>
            <h2>
              The website located at oustro.xyz (the “Site”) is a copyrighted work belonging to Oustro, LLC. (“Company”, “us”,
            ...
            <h2>
              ...
              ARBITRATION. UNLESS YOU OPT OUT OF THE ARBITRATION AGREEMENT: (1) YOU WILL
              ...
              REPRESENTATIVE ACTION OR PROCEEDING; AND (2) YOU ARE WAIVING YOUR RIGHT TO
            ...
            <h2>
              10.2 Dispute Resolution. Please read this Section 10.2 (sometimes referred to herein as this “Arbitration
            ...
            <h2>
              ...
              other equitable relief as set forth below) in connection with these Terms or the use of any product or service
              ...
              arbitration proceedings shall be held in English. This Arbitration Agreement applies to you and the Company, and
            ...
            <h2>
              ...
              claim or dispute, and the requested relief. A Notice to the Company should be sent to: 651 N Broad St, Suite 201,
              Middletown, Delaware 19709. After the Notice is received, you and the Company may attempt to resolve the claim
              or dispute informally. If you and the Company do not resolve the claim or dispute within thirty (30) days after the
            ...
            <h2>
              (c) Arbitration Rules. The Federal Arbitration Act governs the interpretation and enforcement of this
              Arbitration Agreement. The arbitration will be conducted by JAMS, an established alternative dispute resolution
              provider.  Disputes involving claims, counterclaims, or request for relief under $250,000, not inclusive of attorneys’
              fees and interest, shall be subject to JAMS’s most current version of the Streamlined Arbitration Rules and
              procedures available at http://www.jamsadr.com/rules-streamlined-arbitration/; all other disputes shall be subject to
              ...
              forum. Each party shall bear its own costs (including attorney’s fees) and disbursements arising out of the
            ...
            <h2>
              (d) Authority of Arbitrator. The arbitrator shall have exclusive authority to (i) determine the scope and
              enforceability of this Arbitration Agreement and (ii) resolve any dispute related to the interpretation, applicability,
              enforceability or formation of this Arbitration Agreement including, but not limited to, any assertion that all or any
              part of this Arbitration Agreement is void or voidable. The arbitration will decide the rights and liabilities, if any, of
              you and Company. The arbitration proceeding will not be consolidated with any other matters or joined with any
              ...
              available to an individual under applicable law, the arbitral forum’s rules, and these Terms (including the Arbitration
              Agreement). The arbitrator shall issue a written award and statement of decision describing the essential findings
              and conclusions on which the award is based, including the calculation of any damages awarded.  The arbitrator has
              the same authority to award relief on an individual basis that a judge in a court of law would have.  The award of the
            ...
            <h2>
              ...
              and Company are instead electing that all disputes, claims, or requests for relief shall be resolved by arbitration
              under this Arbitration Agreement, except as specified in Section 10.2(a) (Applicability of Arbitration Agreement)
              above.  An arbitrator can award on an individual basis the same damages and relief as a court and must follow these
              Terms as a court would. However, there is no judge or jury in arbitration, and court review of an arbitration award
              is subject to very limited review.
            </h2>
            <h2>
              (f) Waiver of Class or Other Non-Individualized Relief. ALL DISPUTES, CLAIMS, AND REQUESTS
              ...
              OR CONSOLIDATED WITH THOSE OF ANY OTHER CUSTOMER OR USER. If a decision is issued stating
              that applicable law precludes enforcement of any of this section’s limitations as to a given dispute, claim, or request
              for relief, then such aspect must be severed from the arbitration and brought into the State or Federal Courts located
              in the State of Delaware. All other disputes, claims, or requests for relief shall be arbitrated.
            </h2>
            <h2>
              (g) 30-Day Right to Opt Out. You have the right to opt out of the provisions of this Arbitration Agreement
              by sending written notice of your decision to opt out to: support@oustro.xyz, within thirty (30) days after first
              becoming subject to this Arbitration Agreement. Your notice must include your name and address, your Company
              username (if any), the email address you used to set up your Company account (if you have one), and an
              ...
              has no effect on any other arbitration agreements that you may currently have, or may enter in the future, with us.
            </h2>
            <h2>
              (h) Severability. Except as provided in Section 10.2(f) (Waiver of Class or Other Non-Individualized Relief),
              if any part or parts of this Arbitration Agreement are found under the law to be invalid or unenforceable, then such
            ...
            <h2>
              (i) Survival of Agreement. This Arbitration Agreement will survive the termination of your relationship with
              Company.
            </h2>
            <h2>
              (j) Modification. Notwithstanding any provision in these Terms to the contrary, we agree that if Company
              makes any future material change to this Arbitration Agreement, you may reject that change within thirty (30) days
              of such change becoming effective by writing Company at the following address: support@oustro.xyz.
            </h2>
            <h2>
            ...
            <h2>
              Telephone: 8325236282
            </h2>
            <h2>
              Email: support@oustro.xyz
            </h2>
            <h3 id="pp">PRIVACY POLICY</h3>
            <h2>
              Oustro, LLC. (the “Company”) is committed to maintaining robust privacy protections for its
            ...
            <h2>
              ...
              accessed at oustro.xyz or through the mobile application
            </h2>
            <h2>
              “Service” refers to the Company’s services accessed via the Site, in which users can buy,
              sell, list, view, or mint NFTs.
            </h2>
            <h2>
            ...
            <h2>
              ...
              (found here: oustro.xyz) and you consent to our collection, storage, use and disclosure of
            ...
            <h2>
              ...
              submit and number of clicks. Personal Information includes your email, which you submit to us
            ...
            <h2>
              ...
              may use cookies to collect the following information: Website usage, traffick volume on the
              site, and performance metrics of the site.
            </h2>
            <h2>
              The Company may use both persistent and session cookies; persistent cookies remain
              on your computer after you close your session and until you delete them, while session
            ...
            <h2>
              ...
              communications from us in the “Subscriptions” page of the Site. Please note that
              notwithstanding the promotional preferences you indicate by either unsubscribing or opting
              out in the “Subscriptions” page of the Site, we may continue to send you administrative
            ...
            <h2>
              ...
              contact us by sending an email to support@oustro.xyz
              Last Updated: This Privacy Policy was last updated on 11/16/22
            </h2>
          </div>
        </div>
      </div>

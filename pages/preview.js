...
export default function Index() {
  ...
  return (
    <div>
      ...
      <div className='info'>
        <h1>Explore the world's first NFT marketplace for more than just images.</h1>
        <p>Join the only web3 community for filmmakers, musicians, academics, artists, and more.</p>
      </div>
